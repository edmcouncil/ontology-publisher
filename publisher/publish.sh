...
if [ -f ${SCRIPT_DIR}/lib/build-glossary.sh ] ; then
  # shellcheck source=lib/build-glossary.sh
  source ${SCRIPT_DIR}/lib/build-glossary.sh
else
  source lib/build-glossary.sh # This line is only there to make the IntelliJ Bash plugin see build-glossary.sh
fi
